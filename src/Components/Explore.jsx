    ...
    <div className="w-full flex justify-center items-center mt-12 py-20 border-t-[1px] border-b-[1px] border-gray_15">
      <div className="w-[90%] flex as:flex-col sm:flex-row justify-between items-center gap-5">
        ...
        <div className="w-[90%] sm:w-[25%] lg:w-[15%] flex  justify-center items-center">
          <Link
            to={"/aaa"}
            className="w-full sm:w-48  h-16 flex justify-center items-center bg-green-700 rounded-xl p-2 text-white hover:text-black dark:hover:text-white as:text-base lg:text-lg  font-medium hover:bg-inherit boxShadowLight hover:boxShadowLight "
          >
            کاوش ویژگی ها
          </Link>
        </div>
