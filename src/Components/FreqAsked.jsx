...
import CartFreqAsk from "./CartFreqAsk";
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-between items-center gap-2 ">
            <p className="dark:text-white_99 font-normal text-lg  lg:w-[750px] xl:w-[1200px]">
              پاسخ به سوالات رایج در مورد خدمات Estatein، لیست املاک و فرآیند
              املاک و مستغلات را بیابید. ما اینجا هستیم تا وضوح را ارائه دهیم و
              در هر مرحله به شما کمک کنیم.
            </p>
            <Link
