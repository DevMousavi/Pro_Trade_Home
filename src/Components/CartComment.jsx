const CartComment = () => {
  return (
    <div className="flex flex-col gap-10 w-96 h-96 md:w-[413px] lg:w-[512px] rounded-xl p-10  border-primary_green_light bg-white dark:bg-inherit boxShadowLight dark:boxShadowLight">
      ...
      <div className="flex gap-2">
        ...
        <div className="flex flex-col gap-1">
          <h3 className="text-xl font-normal dark:text-white">رضا فریدی</h3>
